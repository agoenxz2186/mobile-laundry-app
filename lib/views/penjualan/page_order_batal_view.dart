...
class PageOrderBatalView extends StatefulWidget {
  const PageOrderBatalView({super.key});

  @override
  State<PageOrderBatalView> createState() => _PageOrderBaruViewState();
}

class _PageOrderBaruViewState extends State<PageOrderBatalView> with AutomaticKeepAliveClientMixin {
